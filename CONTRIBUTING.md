...
5. **Isolated Subtasks**: 1 PR = 1 Feature. Implement each spec on its own branch.
6. **Step-by-Step Commits**: Keep commits atomic and descriptive (`feat: add core website routing (#12)`).
7. **Closed Specs**: Once the issue is closed, the spec is historical. Do not modify closed specs. Create new ones for bugs or new requirements.
